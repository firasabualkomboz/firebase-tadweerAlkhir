          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <button class="btn btn-sm rounded-0 ml-2 btn-danger" type="button" data-toggle="modal" data-target="#delete{{ $video->id() }}" data-toggle="tooltip" data-placement="top" title="Delete">Delete</button>
...
<div class="modal fade" id="delete{{ $video->id() }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-footer">
        ...
        <form id="my-form" action="{{ url('admin/videos/' .$video->id() )  }}" method="POST">
            @csrf
            @method('DELETE')
